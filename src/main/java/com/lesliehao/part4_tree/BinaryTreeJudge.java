...
public class BinaryTreeJudge {
     ...
     * 层序遍历
     * 1.当检查到某个节点只有右儿子时，退出
     * 2.当检查到某个节点只有左儿子或没有儿子时，必须保证接下去所有的节点都是叶子节点，才是完全二叉树
     *
     * @param t
     */
    ...
    boolean isSymmetrical(Node r1, Node r2) {
        ...
        return r1.element == r2.element && isSymmetrical(r1.left, r2.right) && isSymmetrical(r1.right, r2.left);
    }
